...
Pour la cartographie complète et maintenue du projet, utiliser en priorité :
...
- [QUICK_START.md](QUICK_START.md) — Démarrage en quelques minutes
...
- [VISUAL_GUIDE.md](VISUAL_GUIDE.md) — Guide visuel UI
- [PWA_WEB_PUSH_SETUP.md](PWA_WEB_PUSH_SETUP.md) — Setup notifications web push
- [SHARE_READY.md](SHARE_READY.md) — Partage du projet
