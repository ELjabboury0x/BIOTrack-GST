...
return new class extends Migration {
    ...
    {
        Schema::create('bilan_maintenance_correctives', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('intervention_date_text')->nullable();
    ...
    {
        Schema::dropIfExists('bilan_maintenance_correctives');
    }
};
